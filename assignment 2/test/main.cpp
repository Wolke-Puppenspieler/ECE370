...
float EVALUATE_POSTFIX(cNode *QFrontPtr, cNode *QRearPtr)
{
    ...
    cout<<"Evaluation: "<<eTopPtr->eval<<endl;
}
...
void INFIX_TO_POSTFIX(cNode *&infixTop,cNode *&infixList)
{
    ...
    cout << endl;
    EVALUATE_POSTFIX(QFrontPtr, QRearPtr);
    cout << endl << endl;
}
...
int main()
{
    ...
    cout<<"Assignment 2 Welcomes You To Its Presence..."<<endl<<endl;
    while(inData.peek() !=EOF)
    {
        ...
        {
            cout<<endl;
            cout<<"This is not the correct statement, please try again..."<<endl;
        }
    }
    //Sum[counter]=EVALUATE_POSTFIX(infixList,infixTop);
    //int i;
